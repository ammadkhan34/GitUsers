...
class Upload{
     ...
     var dataobj=GithubModel()
    var mydat1:[GithubModelElement]=[]
    var mylabel:UILabel!
    ...
    func gettodata(_ loaddata:Upload,_ Myview:UITableView){
      Mytable=Myview
        let myurl="https://api.github.com/users"
